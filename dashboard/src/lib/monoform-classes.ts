...
// gradients, elevation only for major surfaces and overlays.

/** Secondary control: 36px, hairline border, graphite fill. Pairs with `.mf-action`. */
export const MF_BUTTON =
  "inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-[var(--mf-radius-control)] border border-border-default " +
...
export const MF_BUTTON_QUIET =
  "inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-[var(--mf-radius-control)] border border-transparent " +
...
export const MF_BUTTON_DANGER =
  "inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-[var(--mf-radius-control)] border border-status-critical/40 " +
...
export const MF_INPUT =
  "h-9 rounded-[var(--mf-radius-control)] border-border-default bg-surface-sunken text-[13px] text-text-primary " +
  "placeholder:text-text-disabled";

/** Small caps label above a field. */
export const MF_LABEL = "mb-1.5 block text-[12px] uppercase tracking-[0.05em] text-text-tertiary font-mono";
...
export const MF_PANEL_TITLE = "mf-section-title text-text-primary";
 ...
 */
export const MF_TAB =
  "min-h-10 px-3.5 py-1.5 gap-1.5 text-[13px] text-text-secondary! flex-none data-active:text-text-primary! after:bg-accent!";
...
/** Dialog surface — uses the shared overlay treatment. */
